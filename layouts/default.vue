<template>
  <div>
    <b-navbar variant="transparent" type="dark">
      ...
      <b-navbar-nav class="ml-auto">
        ...
        <b-nav-item href="https://github.com/sergioazoc/" target="_blank">
        ...
        <b-nav-item href="https://twitter.com/sergioazoc/" target="_blank">
          <svg xmlns="http://www.w3.org/2000/svg" class="navbar-nav-svg" viewBox="0 0 512 499.36" role="img" focusable="false">
            <title>Twitter</title>
    ...
    <b-aspect aspect="16:9" tag="header" class="header">
      <b-container class="header__cover d-flex justify-content-center align-items-center text-light flex-column flex-sm-row" fluid>
        <b-img
          class="header__img border border-primary"
